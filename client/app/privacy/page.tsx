...
export const metadata: Metadata = {
  title: 'Политика обработки персональных данных | Palaci',
  description:
    'Политика обработки персональных данных сервиса Palaci: цели обработки, состав данных, права субъектов персональных данных и контакты оператора.',
};
          ...
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-7 text-[#4B5563]">
                Базовый документ сервиса Palaci о том, какие персональные данные обрабатываются,
