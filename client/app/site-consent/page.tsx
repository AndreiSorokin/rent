...
export const metadata: Metadata = {
  title: 'Согласие пользователя сайта на обработку персональных данных | Palaci',
  description:
    'Согласие пользователя сайта Palaci на обработку персональных данных при регистрации, использовании сайта и направлении обращений.',
};
...
const sections = [
  {
    ...
    paragraphs: [
      'Настоящее согласие дается пользователем сайта Palaci свободно, своей волей и в своем интересе в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных».',
      'Согласие предоставляется оператору сервиса Palaci — Индивидуальному предпринимателю Федорову Владимиру Сергеевичу, ОГРНИП 326774600201511, ИНН 366112533269.',
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      'предоставление доступа к сервису Palaci и его функциям;',
          ...
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-7 text-[#4B5563]">
                Этот документ используется при регистрации в Palaci и подтверждает согласие
